...
- AIRTABLE_API_KEY (API key de tu cuenta de Airtable)
- AIRTABLE_BASE_ID (ID de la base de datos de Airtable)
- AUTH_SECRET (secreto para firmar JWTs)

Ver [AIRTABLE_SETUP.md](AIRTABLE_SETUP.md) para instrucciones detalladas de configuración.
...
- `POST /api/setup` — configura la estructura inicial en Airtable (ejecutar 1 vez en dev)
